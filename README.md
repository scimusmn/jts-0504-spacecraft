...
**French Mode:** The application defaults to Spanish translations. To target French translations, add (or edit) a `secondaryLanguage` setting with a a value of `fr`: 
```xml
